  ...
  private function getHtmButtons($id, $row, $numRow)
  {
    ...
    /** Buttons **/
     if($this->bt_delete) {
        ...
        $htmButtons['bt_delete'] = '<button type="button" class="on_delete btn btn-xs btn-danger"><i class="fa fa-trash-o fa-lg"></i>'.$label.'</button>';
     ...
     if($this->bt_update) {
        ...
        $htmButtons['bt_update'] = '<button type="button" class="on_update btn btn-xs btn-default"><i class="fa fa-pencil-square-o fa-lg"></i>'.$label.'</button>';
